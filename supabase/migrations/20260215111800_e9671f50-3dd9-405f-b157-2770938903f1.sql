...
-- Fix E3: Set search_path on 3 custom SECURITY DEFINER functions

CREATE OR REPLACE FUNCTION public.get_last_pulse_per_user()
RETURNS TABLE(user_id uuid, last_pulse timestamp with time zone)
LANGUAGE sql
...
CREATE OR REPLACE FUNCTION public.get_memory_counts()
